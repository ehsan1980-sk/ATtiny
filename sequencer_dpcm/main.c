...
#define SEQUENCER_COUNTUPTO 256 // (256 Bytes * 8 Bits) / 18750 Samples = Approx. 0.109227 Seconds
 ...
 * Bit[7:0]: 1 as Plus Delta to Volume, 0 as Minus Delta to Volume, Read from LSB
 */
uint8_t const sequencer_array_a[SEQUENCER_SEQUENCENUMBER][SEQUENCER_COUNTUPTO] PROGMEM = { // Array in Program Space
	{0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,
	 0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,
	 0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,
	 0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,
	 ...
	 0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,
	 0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,0b00100010,
	 0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101,0b11011101}, // Sequence No.1, Triangle 18750 / (32 * 8) = 73.2421875 Hz
	{0b11111111,0b11111111,0b11111111,0b11111111,0b00000000,0b00000000,0b00000000,0b00000000,
	 ...
	 0b00000000,0b00000000,0b00000000,0b00000000,0b11111111,0b11111111,0b11111111,0b11111111,
	 0b11111111,0b11111111,0b11111111,0b11111111,0b00000000,0b00000000,0b00000000,0b00000000,
	 0b00000000,0b00000000,0b00000000,0b00000000,0b11111111,0b11111111,0b11111111,0b11111111}  // Sequence No.2, Triangle 18750 / (16 * 8) = 146.484375 Hz
};
...
int main(void) {
	...
	uint8_t sequenequecer_array_a_index = 0;
	...
	while(1) {
		...
		if ( input_pin != input_pin_last ) {
			...
			if ( input_pin_last ) { // If Not Zero
				sequenequecer_array_a_index = input_pin_last - 1;
				sequencer_interval_count = 0;
				sequencer_count_update = 0;
		...
		if ( sequencer_count_update != sequencer_count_last ) {
			...
			if ( sequencer_count_last < SEQUENCER_COUNTUPTO_BIT ) {
				sequencer_byte = pgm_read_byte(&(sequencer_array_a[sequenequecer_array_a_index][(sequencer_count_last - 1) >> 3]));
